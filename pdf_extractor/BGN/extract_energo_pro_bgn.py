...
def process_all_pdfs(folder_path: str = ".", output_excel: str = "energo_pro_summary.xlsx"):
    ...
    for pdf_file in pdf_files:
        ...
        if result['status'] == 'success':
            ...
            print(f"  ✓ Успешно | Дневна: {result['day_kwh']} кВтч | Нощна: {result['night_kwh']} кВтч | Сума: {result['total_with_vat']} лв")
        else:
    ...
    if results:
        ...
        df['total_with_vat'] = (pd.to_numeric(df['total_with_vat'], errors='coerce') / 1.95583).round(2)
